...
def therm_to_png(input_file, output_file, scale_factor):
    ...
    # Remove empty strings and convert values to float
    values = [float(value) for value in data if value.strip()]
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        print("Usage: python3 therm2png4.py input_file output_file scale_factor")
        sys.exit(1)
